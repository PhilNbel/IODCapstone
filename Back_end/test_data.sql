...
INSERT INTO Users(firstName,lastName, color,nickName, password) VALUES
    ...
    ('Jordan', 'Klianis','#008F00','Custodes Tech-priest', '$2a$10$qNhJZYMGtyrfEY2fjvhS.u20CvavVLszNYEt1eI7WQ2PPWXiuDxra'), -- wa4a4a4ag#4mm3r
    ('Thomas', 'Knight','#00F000','Fidji','$2a$10$qNhJZYMGtyrfEY2fjvhS.u0rQZSyzi8ypyuF9KYXuDedPHnoGchtG'), -- mod3pas
    ('Justine', 'Villegas','#8F0000', "Adam's badminton partner",'$2a$10$qNhJZYMGtyrfEY2fjvhS.uFMVxxTbIAL2Agapyd2EhpwzZo3f2DbW'), -- badm!nt0n
    ('Adam', 'DeGas','#F00000', "Justine's badminton partner",'$2a$10$qNhJZYMGtyrfEY2fjvhS.uFMVxxTbIAL2Agapyd2EhpwzZo3f2DbW'), -- badm!nt0n
    ('Chris', 'Marsh','#F0F0F0', 'The greatest Australian assistant in IOD','$2a$10$qNhJZYMGtyrfEY2fjvhS.udRCvWzYbe7qq9Tj/jVA0m4RSipUGHiy'), -- !0D
    ('Gareth', 'Wootton','#8F8F8F', 'The greatest Kiwi assistant in IOD','$2a$10$qNhJZYMGtyrfEY2fjvhS.udRCvWzYbe7qq9Tj/jVA0m4RSipUGHiy'), -- !0D

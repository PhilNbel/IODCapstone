...
export default function StepPage({project, step}){ //details the current step
    ...
    function format(step){//similar to ProjectPage format method
    ...
    return <Box width="90vw" minHeight="75vh" sx={{display:"flex",flexDirection:"column", backgroundColor:theme.colors[2],color:theme.colors[4]}}>
        {/*StepPage component*/}
            ...
            {(currPage == "members")?
                ...
                <>
                    {
                        (currPage=="step")?//if we use the tabs, return to the project page
                            format(step)
                            :
